...
Just put code in C:\Github\WpfMockupApp8 and double check that MOCK_DATA.csv is in the Data subdirectory.
...
See RunningExample.jpg for its appearing when running.
